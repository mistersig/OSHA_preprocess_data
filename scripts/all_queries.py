...
#complete 2/18
fatalities_data_data_create_table = '''CREATE TABLE osha_fatalities_data
	(
	incident_date date,
...
#codes,titles
#completed2/178
inspection_data_create_table = '''CREATE TABLE naics_codes_data
	(
	codes int primary key,
	titles varchar(64) null
	);'''
